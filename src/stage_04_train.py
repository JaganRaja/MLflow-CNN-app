...
def main(config_path):
    ...
    logging.info(f"reading the dataset from {PARENT_DIR}")
    ...
    ### prefetch operation(NOT always necessary)
    ...
    logging.info(f"training model saved at {trained_model_file}")

    # here we can write code for validating the model OR we can create seperate stage file
