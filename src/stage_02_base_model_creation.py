...
def main(config_path):
    ...
    # classifier.summary() #returns None. to logging this summary we have to use io.StringIO.. refre function: log_model_summary
    logging.info(f"base model summary:\n{log_model_summary(classifier)}")

    classifier.summary()

    logging.info("model combined...")
    classifier.compile(
    ...
    path_to_model = os.path.join(
        path_to_model_dir, config["data"]["init_model_file"]
    )
